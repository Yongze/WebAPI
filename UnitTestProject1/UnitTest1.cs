...
namespace UnitTestProject1
{
    ...
    public class UnitTest1
    {
        ...
        public void TestGetWinner1() //Get the highest price of this item
        {
            ...
            Assert.AreEqual(result, "89@1c.com with Price of $663");
        }
        ...
        {
            using (SqlConnection connection = new SqlConnection(@"Data Source=YW850\MSSQLSERVER01; Initial catalog=EdApp; Integrated security=true;"))
            {
